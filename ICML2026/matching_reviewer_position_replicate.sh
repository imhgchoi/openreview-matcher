...
export EXPERIMENT=False # Experimental Manipulation
...
export COUNTRY_CONSTRAINTS=False # Use country constraints
...
export MIN_POS_BIDS=0 # minimum number of positive bids in order to take them into account
...
python -m matcher \
	...
	--bad_match_thresholds 0.1 0.3 0.5 \
	--perturbation 1.0 \
...
# ICML26: Use country constraints
