...
# 	ICML2026/$GROUP/$SCORES_FILE
for file in ICML2026/$GROUP/data/bids.csv \
	ICML2026/$GROUP/data/no_or_paper_reviewers.csv \
	ICML2026/$GROUP/emergency-4plus-reviewers.csv \
	ICML2026/$GROUP/reciprocal-reviewer-noBid.csv 
do
	if [ ! -f $file ]; then
...
# cp ICML2026/$GROUP/emergency-4plus-reviewers.csv $ROOT_FOLDER/emergency-4plus-reviewers.csv
# cp ICML2026/$GROUP/reciprocal-reviewer-noBid.csv $ROOT_FOLDER/reciprocal-reviewer-noBid.csv
...
# 	--files $ROOT_FOLDER/affinity_scores.csv \
...
start_time=$SECONDS
python -m matcher \
	--scores $ROOT_FOLDER/affinity_scores.csv $DATA_FOLDER/filtered_bids.csv \
	--weights 1 1 \
	--constraints $DATA_FOLDER/constraints/conflict_constraints.csv \
