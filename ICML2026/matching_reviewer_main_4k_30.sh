...
export GROUP="Reviewers_Main_4K_30"
...
if [ -z "$SLURM_JOB_NAME" ] && [ -z "$SLURM_JOB_ID" ]; then
    ...
    export ROOT_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP"
    export DATA_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP/data"
	export CONSTRAINTS_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP/data/constraints"
    export ASSIGNMENTS_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP/assignments"
    ...
    # sbatch job
    export ROOT_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP/jobs/$SLURM_JOB_ID"
    export DATA_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP/jobs/$SLURM_JOB_ID/data"
	export CONSTRAINTS_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP/jobs/$SLURM_JOB_ID/data/constraints"
    export ASSIGNMENTS_FOLDER="/nobackup2/froilan/ICML_Matching/$GROUP/jobs/$SLURM_JOB_ID/assignments"
fi
