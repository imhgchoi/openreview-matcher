...
mkdir -p $DATA_FOLDER # create the iter2 data folder
cp -r $DATA_FOLDER/* $DATA_FOLDER/ # copy all files and folders to the iter2 data folder
...
printf "\n========================================"
print_time $((SECONDS - script_start_time))
printf "\n"
