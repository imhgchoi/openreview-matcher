...
python ICML2026/scripts/quality_constraints.py \
	--assignments $ITER1_ASSIGNMENTS_FOLDER/first_matching.json \
	--qualification $ITER1_DATA_FOLDER/qualification.csv \
	--output $ITER1_DATA_FOLDER/constraints/quality_constraints.csv
...
python ICML2026/scripts/exclude_reviewers.py \
	...
	--files $ITER1_DATA_FOLDER/affinity_scores.csv \
		...
		$ITER1_DATA_FOLDER/constraints/quality_constraints.csv \
...
python ICML2026/scripts/stat_check.py \
	...
	--bids $ITER1_DATA_FOLDER/bids.csv
...
python ICML2026/scripts/quality_constraints.py \
	--assignments $ITER2_ASSIGNMENTS_FOLDER/first_matching.json \
	--qualification $ITER2_DATA_FOLDER/qualification.csv \
	--output $ITER2_DATA_FOLDER/constraints/quality_constraints.csv
...
python ICML2026/scripts/exclude_reviewers.py \
	...
	--files $ITER2_DATA_FOLDER/affinity_scores.csv \
		...
		$ITER2_DATA_FOLDER/constraints/quality_constraints.csv \
...
python ICML2026/scripts/stat_check.py \
	...
	--bids $ITER2_DATA_FOLDER/bids.csv
...
python ICML2026/scripts/quality_constraints.py \
	--assignments $ITER3_ASSIGNMENTS_FOLDER/first_matching.json \
	--qualification $ITER3_DATA_FOLDER/qualification.csv \
	--output $ITER3_DATA_FOLDER/constraints/quality_constraints.csv
...
python ICML2026/scripts/exclude_reviewers.py \
	...
	--files $ITER3_DATA_FOLDER/affinity_scores.csv \
		...
		$ITER3_DATA_FOLDER/constraints/quality_constraints.csv \
...
python ICML2026/scripts/stat_check.py \
	...
	--bids $ITER3_DATA_FOLDER/bids.csv
